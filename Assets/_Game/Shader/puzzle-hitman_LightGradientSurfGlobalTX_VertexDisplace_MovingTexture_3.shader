Shader "puzzle-hitman/LightGradientSurfGlobalTX_VertexDisplace_MovingTexture" {
	Properties {
		_MainTex ("Albedo (RGB)", 2D) = "white" {}
		_MovingTex ("Moving Texture", 2D) = "white" {}
		_TextureMovementSpeedX ("Moving Texture Speed X", Float) = 0
		_TextureMovementSpeedY ("Moving Texture Speed Y", Float) = 0
