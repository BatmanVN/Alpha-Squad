...
public class ShopChestPackOffer : ShopOffer
{
	[SerializeField]
	private UITextTimer timer;

	[SerializeField]
	private Text labelWeaponChest;

	[SerializeField]
	private Text labelUpgradeChest;

	[SerializeField]
	private Text labelGems;
	...
	private static string LMTJIFNIPIJ;
